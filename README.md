...
**Updating.** Open any **APS** window: the version line at the top shows *(latest)* or *(new x.y.z)*, and whenever a newer version exists an **Update** button sits next to it — whichever way you installed. Use it rather than Package Manager, which updates neither a Git dependency in place nor a customized (embedded) copy — details in the [documentation](documentation.md#51-version--updating).
...
*   🔝 **Front-to-Back Order** — Decide which popup is drawn in front when several share a canvas: drag your popup prefabs into order in **`APS ▸ Order`** (per layer, one click from the layer row, click a row to find the prefab), and APS applies it every time a popup opens — no more "whichever loaded first ends up behind". Two prefabs of one popup class order independently. Tick `Focusable` for click-to-front windows, or call `BringToFront` / `SendToBack` yourself.
...
| **`APS ▸ Order`** | Drag popup prefabs front-to-back, one layer at a time — which popup is drawn above which on that layer's canvas. |
...
<p align="center">
  <img width="35%" alt="Editor View 1" src="https://github.com/user-attachments/assets/dee4ee8f-4b7c-4438-b341-b01bb404086e" />
  <img width="35%" alt="Editor View 2" src="https://github.com/user-attachments/assets/a9aec676-4dbc-4795-a73b-ec21d9f0dcb5" />
</p>
<p align="center">
  <img width="35%" alt="Editor View 3" src="https://github.com/user-attachments/assets/eae9d6fc-0a60-4992-aedf-2d95f1193c45" />
  <img width="35%" alt="Editor View 3" src="https://github.com/user-attachments/assets/d23fa8be-93f7-4316-8920-ffc72c745261" />
</p>
